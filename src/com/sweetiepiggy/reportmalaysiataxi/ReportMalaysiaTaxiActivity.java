...
//        	Context.getSystemService().removeView(camera_button);
...
//        }
    	    	...
    	    	if (results_complete) {
	    	    	...
	    	    	if (tweet_checkbox.isChecked()) {
		    	    	...
		    	    	if (!mPhotoUris.isEmpty()) {
		    	    		tweet_intent.putExtra(Intent.EXTRA_STREAM, Uri.parse(mPhotoUris.get(mPhotoUris.size()-1)));
		    	    	}
    ...
    private String format_sms_msg(String msg) {
    	return getResources().getString(R.string.complaint_malay) +
    			msg;
    }
