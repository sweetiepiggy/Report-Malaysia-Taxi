...
public class AllFareCalcActivity extends Activity {
	...
	private void update_fare() {
		String distance_str = ((EditText) findViewById(R.id.distance_entry))
				.getText().toString();
		...
		String time_str = ((EditText) findViewById(R.id.time_entry)).getText()
				.toString();
		...
		String passengers_str = ((EditText) findViewById(R.id.passengers_entry))
				.getText().toString();
		...
		boolean midnight = ((CheckBox) findViewById(R.id.midnight_checkbox))
				.isChecked();
		boolean exec = ((CheckBox) findViewById(R.id.executive_checkbox))
				.isChecked();
		boolean telbooking = ((CheckBox) findViewById(R.id.telbooking_checkbox))
				.isChecked();
	...
	private double calc_fare_by_dist(int starting_fare, double km,
			int passengers, boolean midnight, boolean exec, boolean telbooking) {
